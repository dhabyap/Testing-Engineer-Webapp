...
return [
    ...
    'title' => config('app.name') . ' Finance System API',
    ...
    'routes' => [
        [
            ...
            'groups' => [
                [
                    'name' => 'COA Categories',
                    'description' => 'Manage kategori Chart of Accounts',
                ],
                [
                    'name' => 'Chart of Accounts',
                    'description' => 'Manage akun-akun dalam kategori',
                ],
                [
                    'name' => 'Transactions',
                    'description' => 'Manage pencatatan transaksi keuangan',
                ],
                [
                    'name' => 'Reports',
                    'description' => 'Generate laporan Profit & Loss',
                ],
            ],
        ],
    ],
